...
export class PageResponseDetailDto extends IntersectionType(
  ResponseDataDetailDto,
  ResponseUserBelongDto,
) {}

export class PageResponseListDto extends IntersectionType(
  OmitType(ResponseDataDetailDto, ['content', 'thumbnail'] as const),
  ResponseUserBelongDto,
) {}

export class PageResponseBelongDto extends IntersectionType(

...
import { NestContext } from 'lib/nest-core'
...
export class MessageService {
  ...
  constructor(
    ...
    this.defaultLanguage = this.config.get<string>('app.message.fallback')
    this.availableLanguages = this.config.get<string[]>('app.message.availableList')
  }
  ...
  setValidationMessage(
    ...
    const messages: Array<IMessageValidationError[]> = []
    ...
    return messages.flat(1) as IMessageValidationError[]
  }

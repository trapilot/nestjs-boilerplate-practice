...
export const authenticationService = {
  signUp: async <T = _components['schemas']['UserProfileResponseDto']>(
    body?: _components['schemas']['UserRequestSignUpDto'],
  ...
  loginWithCredential: async <T = _components['schemas']['AuthResponseLoginDto']>(
    body?: _components['schemas']['UserRequestSignInDto'],
    options?: RequestOptions,
  ): Promise<T> => {
    const query = options?.query || {}
    const search = new URLSearchParams()
  ...
  me: async <T = _components['schemas']['UserProfileResponseDto']>(
    options?: RequestOptions,
  ): Promise<T> => {
    const query = options?.query || {}
    const search = new URLSearchParams()
  ...
  route: async <T = _components['schemas']['UserProfileResponseDto']>(
    options?: RequestOptions,
  ): Promise<T> => {
    const query = options?.query || {}
    const search = new URLSearchParams()
  ...
  editProfile: async <T = _components['schemas']['UserProfileResponseDto']>(
    body?: _components['schemas']['UserEditProfileRequestDto'],
    options?: RequestOptions,
  ): Promise<T> => {
    const query = options?.query || {}
    const search = new URLSearchParams()
  ...
  changePassword: async <T = _components['schemas']['UserProfileResponseDto']>(
    body?: _components['schemas']['UserRequestChangePasswordDto'],
    options?: RequestOptions,
  ): Promise<T> => {
    const query = options?.query || {}
    const search = new URLSearchParams()
  ...
  changeAvatar: async <T = _components['schemas']['UserProfileResponseDto']>(
    body?: unknown,
    options?: RequestOptions,
  ): Promise<T> => {
    const query = options?.query || {}
  ...
  confirmPassword: async <T = any>(
    body?: _components['schemas']['UserVerifyPasswordRequestDto'],
    options?: RequestOptions,
  ): Promise<T> => {
    const query = options?.query || {}
    const search = new URLSearchParams()
  ...
  changeConfirmPassword: async <T = any>(
    body?: _components['schemas']['UserRequestChangeConfirmPasswordDto'],
    options?: RequestOptions,
  ): Promise<T> => {
    const query = options?.query || {}
    const search = new URLSearchParams()
